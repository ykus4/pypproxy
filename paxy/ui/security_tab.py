...
from paxy.security.jwt_checker import extract_jwt_from_headers
from paxy.security.jwt_checker import run_checks as jwt_run_checks
        ...
        with ui.tab_panels(sec_tabs, value=jwt_tab).classes("w-full"):
            ...
            with ui.tab_panel(overflow_tab):
                ...
                async def _run_overflow() -> None:
                    from paxy.security.int_overflow import run_checks as overflow_run_checks
